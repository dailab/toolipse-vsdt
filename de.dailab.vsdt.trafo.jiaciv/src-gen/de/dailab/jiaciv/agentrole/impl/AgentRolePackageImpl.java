...
public class AgentRolePackageImpl extends EPackageImpl implements AgentRolePackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link AgentRolePackage#eINSTANCE} when that field is accessed.
	...
	public static AgentRolePackage init() {
		...
		AgentRolePackageImpl theAgentRolePackage = (AgentRolePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AgentRolePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AgentRolePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(AgentRolePackage.eNS_URI, theAgentRolePackage);
