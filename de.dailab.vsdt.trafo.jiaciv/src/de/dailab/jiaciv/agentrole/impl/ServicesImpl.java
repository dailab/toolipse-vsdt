 ...
 * <ul>
 *   <li>{@link de.dailab.jiaciv.agentrole.impl.ServicesImpl#getService <em>Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServicesImpl extends EObjectImpl implements Services {
	...
	protected EClass eStaticClass() {
		return AgentRolePackage.Literals.SERVICES;
	}
	...
	public EList<ServiceType> getService() {
		if (service == null) {
			service = new EObjectContainmentEList<ServiceType>(ServiceType.class, this, AgentRolePackage.SERVICES__SERVICE);
		}
		return service;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AgentRolePackage.SERVICES__SERVICE:
