...
public class WeatherProxyServiceLocator extends org.apache.axis.client.Service implements org.sercho.WeatherProxyWS.WeatherProxyService {
    ...
    private java.lang.String WeatherProxyServiceSOAP_address = "http://localhost:8080/WeatherProxyWS/services/WeatherProxyServiceSOAP";
    ...
    public org.sercho.WeatherProxyWS.WeatherProxyPT getWeatherProxyServiceSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.sercho.WeatherProxyWS.WeatherProxySOAPStub _stub = new org.sercho.WeatherProxyWS.WeatherProxySOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.sercho.WeatherProxyWS.WeatherProxyPT.class.isAssignableFrom(serviceEndpointInterface)) {
                org.sercho.WeatherProxyWS.WeatherProxySOAPStub _stub = new org.sercho.WeatherProxyWS.WeatherProxySOAPStub(new java.net.URL(WeatherProxyServiceSOAP_address), this);
                _stub.setPortName(getWeatherProxyServiceSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sercho.org/WeatherProxyWS/", "WeatherProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sercho.org/WeatherProxyWS/", "WeatherProxyServiceSOAP"));
        }
