...
public class WeatherProxyPTProxy implements org.sercho.WeatherProxy.WeatherProxyPT {
  private String _endpoint = null;
  private org.sercho.WeatherProxy.WeatherProxyPT weatherProxyPT = null;
  ...
  private void _initWeatherProxyPTProxy() {
    try {
      weatherProxyPT = (new org.sercho.WeatherProxy.WeatherProxyServiceLocator()).getWeatherProxyServiceSOAP();
  ...
  public org.sercho.WeatherProxy.WeatherProxyPT getWeatherProxyPT() {
    if (weatherProxyPT == null)
      _initWeatherProxyPTProxy();
