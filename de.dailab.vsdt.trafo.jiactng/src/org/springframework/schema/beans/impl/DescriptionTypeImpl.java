 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.DescriptionTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptionTypeImpl extends EObjectImpl implements DescriptionType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.DESCRIPTION_TYPE;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, BeansPackage.DESCRIPTION_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.DESCRIPTION_TYPE__MIXED:
