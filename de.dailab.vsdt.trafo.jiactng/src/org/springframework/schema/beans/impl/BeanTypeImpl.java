 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getConstructorArg <em>Constructor Arg</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getLookupMethod <em>Lookup Method</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getReplacedMethod <em>Replaced Method</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getAutowire <em>Autowire</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#isAutowireCandidate <em>Autowire Candidate</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getDependencyCheck <em>Dependency Check</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getDependsOn <em>Depends On</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getDestroyMethod <em>Destroy Method</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getFactoryBean <em>Factory Bean</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getFactoryMethod <em>Factory Method</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getInitMethod <em>Init Method</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getLazyInit <em>Lazy Init</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.BeanTypeImpl#isSingleton <em>Singleton</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BeanTypeImpl extends IdentifiedTypeImpl implements BeanType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.BEAN_TYPE;
	}
	...
	public NotificationChain basicSetDescription(DescriptionType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__DESCRIPTION, oldDescription, newDescription);
	...
	public void setDescription(DescriptionType newDescription) {
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BeansPackage.BEAN_TYPE__DESCRIPTION, null, msgs);
			if (newDescription != null)
				msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BeansPackage.BEAN_TYPE__DESCRIPTION, null, msgs);
			msgs = basicSetDescription(newDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__DESCRIPTION, newDescription, newDescription));
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, BeansPackage.BEAN_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<MetaType> getMeta() {
		return getGroup().list(BeansPackage.Literals.BEAN_TYPE__META);
	}
	...
	public EList<ConstructorArgType> getConstructorArg() {
		return getGroup().list(BeansPackage.Literals.BEAN_TYPE__CONSTRUCTOR_ARG);
	}
	...
	public EList<PropertyType> getProperty() {
		return getGroup().list(BeansPackage.Literals.BEAN_TYPE__PROPERTY);
	}
	...
	public EList<LookupMethodType> getLookupMethod() {
		return getGroup().list(BeansPackage.Literals.BEAN_TYPE__LOOKUP_METHOD);
	}
	...
	public EList<ReplacedMethodType> getReplacedMethod() {
		return getGroup().list(BeansPackage.Literals.BEAN_TYPE__REPLACED_METHOD);
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(BeansPackage.Literals.BEAN_TYPE__ANY);
	}
	...
	public void setAbstract(boolean newAbstract) {
		...
		abstractESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__ABSTRACT, oldAbstract, abstract_, !oldAbstractESet));
	}
	...
	public void unsetAbstract() {
		...
		abstractESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BeansPackage.BEAN_TYPE__ABSTRACT, oldAbstract, ABSTRACT_EDEFAULT, oldAbstractESet));
	}
	...
	public void setAutowire(AutowireType newAutowire) {
		...
		autowireESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__AUTOWIRE, oldAutowire, autowire, !oldAutowireESet));
	}
	...
	public void unsetAutowire() {
		...
		autowireESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BeansPackage.BEAN_TYPE__AUTOWIRE, oldAutowire, AUTOWIRE_EDEFAULT, oldAutowireESet));
	}
	...
	public void setAutowireCandidate(boolean newAutowireCandidate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__AUTOWIRE_CANDIDATE, oldAutowireCandidate, autowireCandidate, !oldAutowireCandidateESet));
	}
	...
	public void unsetAutowireCandidate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BeansPackage.BEAN_TYPE__AUTOWIRE_CANDIDATE, oldAutowireCandidate, AUTOWIRE_CANDIDATE_EDEFAULT, oldAutowireCandidateESet));
	}
	...
	public void setClass(String newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDependencyCheck(DependencyCheckType newDependencyCheck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__DEPENDENCY_CHECK, oldDependencyCheck, dependencyCheck, !oldDependencyCheckESet));
	}
	...
	public void unsetDependencyCheck() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BeansPackage.BEAN_TYPE__DEPENDENCY_CHECK, oldDependencyCheck, DEPENDENCY_CHECK_EDEFAULT, oldDependencyCheckESet));
	}
	...
	public void setDependsOn(String newDependsOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__DEPENDS_ON, oldDependsOn, dependsOn));
	}
	...
	public void setDestroyMethod(String newDestroyMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__DESTROY_METHOD, oldDestroyMethod, destroyMethod));
	}
	...
	public void setFactoryBean(String newFactoryBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__FACTORY_BEAN, oldFactoryBean, factoryBean));
	}
	...
	public void setFactoryMethod(String newFactoryMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__FACTORY_METHOD, oldFactoryMethod, factoryMethod));
	}
	...
	public void setInitMethod(String newInitMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__INIT_METHOD, oldInitMethod, initMethod));
	}
	...
	public void setLazyInit(DefaultableBoolean newLazyInit) {
		...
		lazyInitESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__LAZY_INIT, oldLazyInit, lazyInit, !oldLazyInitESet));
	}
	...
	public void unsetLazyInit() {
		...
		lazyInitESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BeansPackage.BEAN_TYPE__LAZY_INIT, oldLazyInit, LAZY_INIT_EDEFAULT, oldLazyInitESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__NAME, oldName, name));
	}
	...
	public void setParent(String newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__PARENT, oldParent, parent));
	}
	...
	public void setScope(String newScope) {
		...
		scope = newScope;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__SCOPE, oldScope, scope));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, BeansPackage.BEAN_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public void setSingleton(boolean newSingleton) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.BEAN_TYPE__SINGLETON, oldSingleton, singleton));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.BEAN_TYPE__DESCRIPTION:
				return basicSetDescription(null, msgs);
			case BeansPackage.BEAN_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__META:
				return ((InternalEList<?>)getMeta()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__CONSTRUCTOR_ARG:
				return ((InternalEList<?>)getConstructorArg()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__PROPERTY:
				return ((InternalEList<?>)getProperty()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__LOOKUP_METHOD:
				return ((InternalEList<?>)getLookupMethod()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__REPLACED_METHOD:
				return ((InternalEList<?>)getReplacedMethod()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case BeansPackage.BEAN_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BeansPackage.BEAN_TYPE__ABSTRACT:
				return isAbstract() ? Boolean.TRUE : Boolean.FALSE;
			case BeansPackage.BEAN_TYPE__AUTOWIRE:
				return getAutowire();
			case BeansPackage.BEAN_TYPE__AUTOWIRE_CANDIDATE:
				return isAutowireCandidate() ? Boolean.TRUE : Boolean.FALSE;
			case BeansPackage.BEAN_TYPE__CLASS:
				return getClass_();
			case BeansPackage.BEAN_TYPE__DEPENDENCY_CHECK:
				return getDependencyCheck();
			case BeansPackage.BEAN_TYPE__DEPENDS_ON:
				return getDependsOn();
			case BeansPackage.BEAN_TYPE__DESTROY_METHOD:
				return getDestroyMethod();
			case BeansPackage.BEAN_TYPE__FACTORY_BEAN:
				return getFactoryBean();
			case BeansPackage.BEAN_TYPE__FACTORY_METHOD:
				return getFactoryMethod();
			case BeansPackage.BEAN_TYPE__INIT_METHOD:
				return getInitMethod();
			case BeansPackage.BEAN_TYPE__LAZY_INIT:
				return getLazyInit();
			case BeansPackage.BEAN_TYPE__NAME:
				return getName();
			case BeansPackage.BEAN_TYPE__PARENT:
				return getParent();
			case BeansPackage.BEAN_TYPE__SCOPE:
				return getScope();
			case BeansPackage.BEAN_TYPE__ANY_ATTRIBUTE:
				if (coreType) return getAnyAttribute();
				return ((FeatureMap.Internal)getAnyAttribute()).getWrapper();
			case BeansPackage.BEAN_TYPE__SINGLETON:
