 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.LookupMethodTypeImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.LookupMethodTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LookupMethodTypeImpl extends EObjectImpl implements LookupMethodType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.LOOKUP_METHOD_TYPE;
	}
	...
	public void setBean(String newBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.LOOKUP_METHOD_TYPE__BEAN, oldBean, bean));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.LOOKUP_METHOD_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BeansPackage.LOOKUP_METHOD_TYPE__BEAN:
				return getBean();
			case BeansPackage.LOOKUP_METHOD_TYPE__NAME:
				return getName();
		}
