 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.IdrefTypeImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.IdrefTypeImpl#getLocal <em>Local</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdrefTypeImpl extends EObjectImpl implements IdrefType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.IDREF_TYPE;
	}
	...
	public void setBean(String newBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.IDREF_TYPE__BEAN, oldBean, bean));
	}
	...
	public void setLocal(String newLocal) {
		...
		local = newLocal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.IDREF_TYPE__LOCAL, oldLocal, local));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BeansPackage.IDREF_TYPE__BEAN:
				return getBean();
			case BeansPackage.IDREF_TYPE__LOCAL:
				return getLocal();
		}
