 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.TypedCollectionTypeImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypedCollectionTypeImpl extends BaseCollectionTypeImpl implements TypedCollectionType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.TYPED_COLLECTION_TYPE;
	}
	...
	public void setValueType(String newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.TYPED_COLLECTION_TYPE__VALUE_TYPE, oldValueType, valueType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BeansPackage.TYPED_COLLECTION_TYPE__VALUE_TYPE:
				return getValueType();
		}
