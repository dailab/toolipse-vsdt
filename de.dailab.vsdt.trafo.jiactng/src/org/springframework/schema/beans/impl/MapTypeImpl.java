 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.MapTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.MapTypeImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.MapTypeImpl#getKeyType <em>Key Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MapTypeImpl extends TypedCollectionTypeImpl implements MapType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.MAP_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, BeansPackage.MAP_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<EntryType> getEntry() {
		return getGroup().list(BeansPackage.Literals.MAP_TYPE__ENTRY);
	}
	...
	public void setKeyType(String newKeyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.MAP_TYPE__KEY_TYPE, oldKeyType, keyType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.MAP_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case BeansPackage.MAP_TYPE__ENTRY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BeansPackage.MAP_TYPE__ENTRY:
				return getEntry();
			case BeansPackage.MAP_TYPE__KEY_TYPE:
				return getKeyType();
		}
