 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.ReplacedMethodTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.ReplacedMethodTypeImpl#getArgType <em>Arg Type</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.ReplacedMethodTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.ReplacedMethodTypeImpl#getReplacer <em>Replacer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReplacedMethodTypeImpl extends EObjectImpl implements ReplacedMethodType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.REPLACED_METHOD_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, BeansPackage.REPLACED_METHOD_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ArgTypeType> getArgType() {
		return getGroup().list(BeansPackage.Literals.REPLACED_METHOD_TYPE__ARG_TYPE);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.REPLACED_METHOD_TYPE__NAME, oldName, name));
	}
	...
	public void setReplacer(String newReplacer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.REPLACED_METHOD_TYPE__REPLACER, oldReplacer, replacer));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.REPLACED_METHOD_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case BeansPackage.REPLACED_METHOD_TYPE__ARG_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BeansPackage.REPLACED_METHOD_TYPE__ARG_TYPE:
				return getArgType();
			case BeansPackage.REPLACED_METHOD_TYPE__NAME:
				return getName();
			case BeansPackage.REPLACED_METHOD_TYPE__REPLACER:
				return getReplacer();
		}
