...
public class BeansPackageImpl extends EPackageImpl implements BeansPackage {
	 ...
	 * @see org.springframework.schema.beans.BeansPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BeansPackage init() {
		...
		BeansPackageImpl theBeansPackage = (BeansPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof BeansPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new BeansPackageImpl());
	 ...
	 * @generated
	 */
	public EAttribute getBeanType_Singleton() {
		return (EAttribute)beanTypeEClass.getEStructuralFeatures().get(23);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(beanTypeEClass, BEAN_TYPE__SINGLETON);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBeanType_Singleton(), ecorePackage.getEBoolean(), "singleton", "true", 0, 1, BeanType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
