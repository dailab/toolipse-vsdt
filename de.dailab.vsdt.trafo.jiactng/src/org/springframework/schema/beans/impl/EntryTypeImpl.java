 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getIdref <em>Idref</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getNull <em>Null</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getList <em>List</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getSet <em>Set</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getMap <em>Map</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getProps <em>Props</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getKey1 <em>Key1</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getKeyRef <em>Key Ref</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getValue1 <em>Value1</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.EntryTypeImpl#getValueRef <em>Value Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntryTypeImpl extends EObjectImpl implements EntryType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.ENTRY_TYPE;
	}
	...
	public NotificationChain basicSetKey(KeyType newKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__KEY, oldKey, newKey);
	...
	public void setKey(KeyType newKey) {
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject)key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BeansPackage.ENTRY_TYPE__KEY, null, msgs);
			if (newKey != null)
				msgs = ((InternalEObject)newKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BeansPackage.ENTRY_TYPE__KEY, null, msgs);
			msgs = basicSetKey(newKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__KEY, newKey, newKey));
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, BeansPackage.ENTRY_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<BeanType> getBean() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__BEAN);
	}
	...
	public EList<RefType> getRef() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__REF);
	}
	...
	public EList<IdrefType> getIdref() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__IDREF);
	}
	...
	public EList<ValueType> getValue() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__VALUE);
	}
	...
	public EList<NullType> getNull() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__NULL);
	}
	...
	public EList<ListOrSetType> getList() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__LIST);
	}
	...
	public EList<ListOrSetType> getSet() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__SET);
	}
	...
	public EList<MapType> getMap() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__MAP);
	}
	...
	public EList<PropsType> getProps() {
		return getGroup().list(BeansPackage.Literals.ENTRY_TYPE__PROPS);
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(BeansPackage.Literals.ENTRY_TYPE__ANY);
	}
	...
	public void setKey1(String newKey1) {
		...
		key1 = newKey1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__KEY1, oldKey1, key1));
	}
	...
	public void setKeyRef(String newKeyRef) {
		...
		keyRef = newKeyRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__KEY_REF, oldKeyRef, keyRef));
	}
	...
	public void setValue1(String newValue1) {
		...
		value1 = newValue1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__VALUE1, oldValue1, value1));
	}
	...
	public void setValueRef(String newValueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.ENTRY_TYPE__VALUE_REF, oldValueRef, valueRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.ENTRY_TYPE__KEY:
				return basicSetKey(null, msgs);
			case BeansPackage.ENTRY_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__BEAN:
				return ((InternalEList<?>)getBean()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__REF:
				return ((InternalEList<?>)getRef()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__IDREF:
				return ((InternalEList<?>)getIdref()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__VALUE:
				return ((InternalEList<?>)getValue()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__NULL:
				return ((InternalEList<?>)getNull()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__LIST:
				return ((InternalEList<?>)getList()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__SET:
				return ((InternalEList<?>)getSet()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__MAP:
				return ((InternalEList<?>)getMap()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__PROPS:
				return ((InternalEList<?>)getProps()).basicRemove(otherEnd, msgs);
			case BeansPackage.ENTRY_TYPE__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BeansPackage.ENTRY_TYPE__KEY1:
				return getKey1();
			case BeansPackage.ENTRY_TYPE__KEY_REF:
				return getKeyRef();
			case BeansPackage.ENTRY_TYPE__VALUE1:
				return getValue1();
			case BeansPackage.ENTRY_TYPE__VALUE_REF:
				return getValueRef();
		}
