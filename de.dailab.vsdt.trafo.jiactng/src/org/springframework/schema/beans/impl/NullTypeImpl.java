 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.NullTypeImpl#getMixed <em>Mixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NullTypeImpl extends EObjectImpl implements NullType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.NULL_TYPE;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, BeansPackage.NULL_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BeansPackage.NULL_TYPE__MIXED:
