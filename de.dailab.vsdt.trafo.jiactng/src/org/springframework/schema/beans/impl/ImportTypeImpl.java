 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.ImportTypeImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportTypeImpl extends EObjectImpl implements ImportType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.IMPORT_TYPE;
	}
	...
	public void setResource(String newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.IMPORT_TYPE__RESOURCE, oldResource, resource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BeansPackage.IMPORT_TYPE__RESOURCE:
				return getResource();
		}
