 ...
 * <ul>
 *   <li>{@link org.springframework.schema.beans.impl.RefTypeImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.RefTypeImpl#getLocal <em>Local</em>}</li>
 *   <li>{@link org.springframework.schema.beans.impl.RefTypeImpl#getParent <em>Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefTypeImpl extends EObjectImpl implements RefType {
	...
	protected EClass eStaticClass() {
		return BeansPackage.Literals.REF_TYPE;
	}
	...
	public void setBean(String newBean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.REF_TYPE__BEAN, oldBean, bean));
	}
	...
	public void setLocal(String newLocal) {
		...
		local = newLocal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.REF_TYPE__LOCAL, oldLocal, local));
	}
	...
	public void setParent(String newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BeansPackage.REF_TYPE__PARENT, oldParent, parent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BeansPackage.REF_TYPE__BEAN:
				return getBean();
			case BeansPackage.REF_TYPE__LOCAL:
				return getLocal();
			case BeansPackage.REF_TYPE__PARENT:
				return getParent();
		}
