 ...
 * @generated
 */
public interface VxlFunction extends VxlElement
{
  /**
   ...
   * @see #setName(String)
   * @see de.dailab.vsdt.vxl.vxl.VxlPackage#getVxlFunction_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.dailab.vsdt.vxl.vxl.VxlFunction#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.dailab.vsdt.vxl.vxl.VxlPackage#getVxlFunction_Empty()
   * @model
   * @generated
   */
  boolean isEmpty();
  ...
  /**
   * Sets the value of the '{@link de.dailab.vsdt.vxl.vxl.VxlFunction#isEmpty <em>Empty</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.dailab.vsdt.vxl.vxl.VxlPackage#getVxlFunction_Body()
  ...
  /**
   * Sets the value of the '{@link de.dailab.vsdt.vxl.vxl.VxlFunction#getBody <em>Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
