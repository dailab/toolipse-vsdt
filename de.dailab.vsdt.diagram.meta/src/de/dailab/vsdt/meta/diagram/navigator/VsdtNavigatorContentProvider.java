...
import de.dailab.vsdt.meta.diagram.part.Messages;
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), BusinessProcessSystemEditPart.MODEL_ID),
					file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case BusinessProcessSystemEditPart.VISUAL_ID: {
			...
			VsdtNavigatorGroup links = new VsdtNavigatorGroup(
					Messages.NavigatorGroupName_BusinessProcessSystem_79_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ParticipantEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					BusinessProcessDiagramEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case ParticipantEditPart.VISUAL_ID: {
			...
			VsdtNavigatorGroup outgoinglinks = new VsdtNavigatorGroup(
					Messages.NavigatorGroupName_Participant_1001_outgoinglinks,
		...
		case BusinessProcessDiagramEditPart.VISUAL_ID: {
			...
			VsdtNavigatorGroup incominglinks = new VsdtNavigatorGroup(
					Messages.NavigatorGroupName_BusinessProcessDiagram_1002_incominglinks,
		...
		case ParticipantAssociatedProcessesEditPart.VISUAL_ID: {
			...
			VsdtNavigatorGroup target = new VsdtNavigatorGroup(
					Messages.NavigatorGroupName_ParticipantAssociatedProcesses_3001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			VsdtNavigatorGroup source = new VsdtNavigatorGroup(
					Messages.NavigatorGroupName_ParticipantAssociatedProcesses_3001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), BusinessProcessDiagramEditPart.VISUAL_ID);
