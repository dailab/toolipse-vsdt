...
import de.dailab.vsdt.meta.diagram.edit.policies.VsdtTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ParticipantNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				VsdtVisualIDRegistry
						.getType(de.dailab.vsdt.meta.diagram.edit.parts.ParticipantNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
					VsdtElementTypes.Participant_1001, getParserElement(),
					parserHint);
