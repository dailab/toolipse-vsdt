...
import de.dailab.vsdt.meta.diagram.edit.helpers.VsdtBaseEditHelper;
...
public class VsdtBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateParticipantAssociatedProcesses_3001(
				Participant source, BusinessProcessDiagram target) {
			if (source != null) {
				if (source.getAssociatedProcesses().contains(target)) {
					return false;
				}
			}
			return canExistParticipantAssociatedProcesses_3001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistParticipantAssociatedProcesses_3001(
				Participant source, BusinessProcessDiagram target) {
