package de.dailab.vsdt.diagram.sheet;
...
import de.dailab.vsdt.diagram.navigator.VsdtNavigatorGroup;
...
public class VsdtSheetLabelProvider extends DecoratingLabelProvider {
	...
	public VsdtSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(VsdtDiagramEditorPlugin
