...
import de.dailab.vsdt.diagram.edit.helpers.VsdtBaseEditHelper;
import de.dailab.vsdt.diagram.expressions.VsdtAbstractExpression;
import de.dailab.vsdt.diagram.expressions.VsdtOCLFactory;
...
public class VsdtBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					VsdtBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static VsdtAbstractExpression SequenceFlow_3001_TargetExpression;
		/**
		 * @generated
		 */
		private static VsdtAbstractExpression MessageFlow_3002_TargetExpression;

		/**
		 * @generated
		 */
		public static boolean canCreateSequenceFlow_3001(
				BusinessProcessDiagram container, FlowObject source,
				FlowObject target) {
			return canExistSequenceFlow_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateMessageFlow_3002(
				BusinessProcessDiagram container, Node source, Node target) {
			return canExistMessageFlow_3002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateAssociation_3003(
				BusinessProcessDiagram container, GraphicalObject source,
		 ...
		 * @generated
		 */
		public static boolean canExistSequenceFlow_3001(
				BusinessProcessDiagram container, FlowObject source,
				FlowObject target) {
			try {
				if (target == null) {
				...
				if (SequenceFlow_3001_TargetExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR,
							VsdtPackage.eINSTANCE.getFlowObject());
					SequenceFlow_3001_TargetExpression = VsdtOCLFactory
							.getExpression(
									"self.getAbstractProcess() = oppositeEnd.getAbstractProcess()", VsdtPackage.eINSTANCE.getFlowObject(), env); //$NON-NLS-1$
				}
				Object targetVal = SequenceFlow_3001_TargetExpression.evaluate(
		 ...
		 * @generated
		 */
		public static boolean canExistMessageFlow_3002(
				BusinessProcessDiagram container, Node source, Node target) {
			try {
				if (target == null) {
					return true;
				}
				if (MessageFlow_3002_TargetExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR,
							VsdtPackage.eINSTANCE.getNode());
					MessageFlow_3002_TargetExpression = VsdtOCLFactory
							.getExpression(
									"self.getPool() <> oppositeEnd.getPool()", VsdtPackage.eINSTANCE.getNode(), env); //$NON-NLS-1$
				}
				Object targetVal = MessageFlow_3002_TargetExpression.evaluate(
						target, Collections.singletonMap(OPPOSITE_END_VAR,
								source));
				if (false == targetVal instanceof Boolean
						|| !((Boolean) targetVal).booleanValue()) {
		 ...
		 * @generated
		 */
		public static boolean canExistAssociation_3003(
				BusinessProcessDiagram container, GraphicalObject source,
				GraphicalObject target) {
