...
import de.dailab.vsdt.diagram.edit.policies.VsdtTextSelectionEditPolicy;
import de.dailab.vsdt.diagram.figures.PlainLabelFigure;
 ...
 * @generated
 */
public class IntermediateNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				VsdtVisualIDRegistry
						.getType(de.dailab.vsdt.diagram.edit.parts.IntermediateNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public IntermediateNameEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof VsdtTextSelectionEditPolicy) {
			((VsdtTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
					VsdtElementTypes.Intermediate_2003, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), VsdtEditPartFactory
