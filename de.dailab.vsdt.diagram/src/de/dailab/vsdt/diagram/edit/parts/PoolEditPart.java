...
import de.dailab.vsdt.diagram.edit.policies.PoolItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class PoolEditPart extends AbstractPoolEditPart {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == VsdtElementTypes.Lane_2001) {
									EditPart compartmentEditPart = getChildBySemanticHint(VsdtVisualIDRegistry
	 ...
	 * @generated
	 */
	public SwimlaneFigure getPrimaryShape() {
		return (SwimlaneFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PoolNameEditPart) {
			((PoolNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getSwimlaneNameFigure());
			return true;
		}
		if (childEditPart instanceof PoolPoolCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getSwimlaneCompartmentFigure();
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PoolPoolCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getSwimlaneCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((PoolPoolCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof PoolPoolCompartmentEditPart) {
			return getPrimaryShape().getSwimlaneCompartmentFigure();
		}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
				.DPtoLP(500), getMapMode().DPtoLP(100));
		return result;
	}
