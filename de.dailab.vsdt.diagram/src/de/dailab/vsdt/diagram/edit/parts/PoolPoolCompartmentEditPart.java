...
import de.dailab.vsdt.diagram.edit.policies.PoolPoolCompartmentCanonicalEditPolicy;
import de.dailab.vsdt.diagram.edit.policies.PoolPoolCompartmentItemSemanticEditPolicy;
import de.dailab.vsdt.diagram.part.Messages;

/**
 * prevent this from changing back to xy layout when regenerating
 * 
 * @generated NOT
 */
public class PoolPoolCompartmentEditPart extends ListCompartmentEditPart {
	...
	/**
	 * + setTooltip(null)
	 * + improved layout (stretching lanes over the pool's whole height)
	 * @generated NOT
	 */
