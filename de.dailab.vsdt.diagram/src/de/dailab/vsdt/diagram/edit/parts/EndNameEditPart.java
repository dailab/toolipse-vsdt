 ...
 * @generated
 */
public class EndNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				VsdtVisualIDRegistry
						.getType(de.dailab.vsdt.diagram.edit.parts.EndNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
					VsdtElementTypes.End_2004, getParserElement(), parserHint);
