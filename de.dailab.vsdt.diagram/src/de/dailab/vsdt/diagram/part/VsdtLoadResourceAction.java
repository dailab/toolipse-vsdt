...
public class VsdtLoadResourceAction implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private BusinessProcessDiagramEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof BusinessProcessDiagramEditPart) {
				mySelectedElement = (BusinessProcessDiagramEditPart) structuredSelection
						.getFirstElement();
			}
		}
