 ...
 */
public abstract class AbstractEndEditPart extends AbstractVsdtBorderedShapeEditPart implements IVsdtEditPart {
	...
	protected IFigure initNodeShape() {
		EventFigure figure= new EventFigure(EventFigure.END, getCastedModel().getTrigger(), true);
		return figure;
	}
