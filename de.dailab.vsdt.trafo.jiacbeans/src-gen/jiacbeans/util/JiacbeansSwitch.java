 ...
 * @generated
 */
public class JiacbeansSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JiacbeansPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiacbeansPackage.PROCESS: {
				jiacbeans.Process process = (jiacbeans.Process)theEObject;
			...
			case JiacbeansPackage.AGENT_BEAN: {
				...
				if (result == null) result = caseProcess(agentBean);
				if (result == null) result = caseNamedElement(agentBean);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiacbeansPackage.SUB_PROCESS: {
				...
				if (result == null) result = caseNamedElement(subProcess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JiacbeansPackage.PARALLEL: {
				Parallel parallel = (Parallel)theEObject;
				T result = caseParallel(parallel);
				if (result == null) result = caseScript(parallel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiacbeansPackage.RUNNER: {
				Runner runner = (Runner)theEObject;
				T result = caseRunner(runner);
				if (result == null) result = caseScript(runner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseProcess(jiacbeans.Process object) {
		return null;
	}
