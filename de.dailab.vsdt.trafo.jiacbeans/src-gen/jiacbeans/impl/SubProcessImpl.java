 ...
 * <ul>
 *   <li>{@link jiacbeans.impl.SubProcessImpl#getRunContent <em>Run Content</em>}</li>
 ...
 * @generated
 */
public class SubProcessImpl extends ScriptImpl implements SubProcess {
	/**
		...
		if (runContent != null && runContent.eIsProxy()) {
			...
			if (runContent != oldRunContent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JiacbeansPackage.SUB_PROCESS__RUN_CONTENT, oldRunContent, runContent));
			}
		}
		return runContent;
	}
	...
	public void setRunContent(Script newRunContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JiacbeansPackage.SUB_PROCESS__RUN_CONTENT, oldRunContent, runContent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JiacbeansPackage.SUB_PROCESS__RUN_CONTENT:
	...
	public String toString(){
		...
		if(runContent!=null){
			...
			try{
				...
				content += "\t//Error occured while reading loop body\n";
			}
		}
