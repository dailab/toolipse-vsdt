...
public class ActionImpl extends EObjectImpl implements Action {
		...
		if (trigger != null && trigger.eIsProxy()) {
			...
			if (trigger != oldTrigger) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JiacbeansPackage.ACTION__TRIGGER, oldTrigger, trigger));
			}
		}
		return trigger;
	}
	...
	public void setTrigger(Trigger newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JiacbeansPackage.ACTION__TRIGGER, oldTrigger, trigger));
	}
