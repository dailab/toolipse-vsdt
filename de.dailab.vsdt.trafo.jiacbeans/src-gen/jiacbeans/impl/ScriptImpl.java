 ...
 * <ul>
 *   <li>{@link jiacbeans.impl.ScriptImpl#getCode <em>Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScriptImpl extends EObjectImpl implements Script {
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JiacbeansPackage.SCRIPT__CODE, oldCode, code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JiacbeansPackage.SCRIPT__CODE:
				return getCode();
		}
