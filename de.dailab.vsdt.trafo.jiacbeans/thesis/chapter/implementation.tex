...
\subsection{Implementation of the Event Handlers}
...
The first pull element will allow the user to put any comments between the \verb|<!-- begin-user-doc -->| and the \verb|<!-- end-user-doc -->| tags. %This is very useful since we know that the position of a javadoc comment is always before the element's declaration. 
