...
public class AgentBeanGenerator
{
  ...
  protected final String TEXT_3 = NL + NL + "import de.dailab.jiactng.agentcore.action.AbstractMethodExposingBean;" + NL + "import de.dailab.jiactng.agentcore.action.scope.ActionScope;";
