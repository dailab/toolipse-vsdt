...
public class Bpmn2JiacVExportWizardOptionsPage extends BpmnExportWizardOptionsPage {
	...
	public Bpmn2JiacVExportWizardOptionsPage(String title, IStructuredSelection selection) {
