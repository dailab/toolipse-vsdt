...
public class StrucBpmnPackageImpl extends EPackageImpl implements StrucBpmnPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link StrucBpmnPackage#eINSTANCE} when that field is accessed.
	...
	public static StrucBpmnPackage init() {
		...
		StrucBpmnPackageImpl theStrucBpmnPackage = (StrucBpmnPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof StrucBpmnPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new StrucBpmnPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(StrucBpmnPackage.eNS_URI, theStrucBpmnPackage);
