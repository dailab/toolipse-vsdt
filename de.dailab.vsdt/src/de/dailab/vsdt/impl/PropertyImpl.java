...
public class PropertyImpl extends EObjectImpl implements Property {
	...
	protected EClass eStaticClass() {
		return VsdtPackage.Literals.PROPERTY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VsdtPackage.PROPERTY__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VsdtPackage.PROPERTY__TYPE, oldType, type));
	}
