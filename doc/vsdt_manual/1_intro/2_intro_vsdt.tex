%
% Das folgende ist teilweise aus dem zweiten Abschnitt des MDE4BPM-Paper
%
...
\begin{figure}
	\centering
	\includegraphics[height=.4\textheight]{figures/vsdt_1-1-3.png}
...
%\Comment{Das zum Metamodell ist für das Handbuch eigentlich nicht nötig, gerade die StrucBPMN-Erweiterung... andererseits, da ist sowieso noch platz auf der seite}
...
For more information regarding the Visual Service Design Tool, please refer to~\cite{kuester2008towards}.

\section{Features}

% Stand: Version 1.2.2

In the following, some of the features of the VSDT are listed.  For more information on selected features, please refer to Section~\ref{sec:user_features}.
