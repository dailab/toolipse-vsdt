...
% vorgemerkt fuer naechsten release
%	\item added `cleanup diagram' functionality

\paragraph{Version 1.4.8}
\begin{itemize}
	\item required Java version is now 1.8
	\item improved layout of Properties sections
	\item visualization of JIAC interpreter state in the diagram
