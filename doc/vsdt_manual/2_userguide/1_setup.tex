...
%	\item \emph{VSDT: RSD Integration} This feature contributes an additional view to the BPMN editor, making the reuse of existing Web services easier.
%	\item \emph{VSDT: Transformation Base} This is an enabling feature for the several export features, providing the common functionality and look and feel for the transformations.
