...
/**
 * This class provides a number of preferably static, target-language independent methods 
...
public class BpmnMappingHelper {
	...
	/**
	 * This method is needed for preventing infinite loops when mapping reference activities. This method checks whether
	 * the referenced activity is a parent of the referencing activity. Doing so it also gets cases in which the reference task
	 * is referencing a subprocess, holding another reference task, referencing the subprocess holding the original reference task.
	 * 
	...
	public static boolean isParentOrEqual(FlowObject parent, FlowObject child) {
		//going from parent to children. normally, subprocess hierarchies won't be very deep, so this should not be a problem
		...
		//alternative version: going up is fast, but it does not get cross references (a1<>-r1, a2<>-r2, r1->a2, r2->a1)
