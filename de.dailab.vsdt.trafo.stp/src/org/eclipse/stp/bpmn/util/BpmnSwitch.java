...
public class BpmnSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BpmnPackage.ACTIVITY: {
				...
				if (result == null) result = caseMessageVertex(activity);
				if (result == null) result = caseAssociationTarget(activity);
			...
			case BpmnPackage.ASSOCIATION_TARGET: {
			...
			case BpmnPackage.LANE: {
				...
				if (result == null) result = caseAssociationTarget(lane);
			...
			case BpmnPackage.MESSAGE_VERTEX: {
				MessageVertex messageVertex = (MessageVertex)theEObject;
				T result = caseMessageVertex(messageVertex);
				if (result == null) result = caseNamedBpmnObject(messageVertex);
				if (result == null) result = caseIdentifiable(messageVertex);
				if (result == null) result = caseEModelElement(messageVertex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case BpmnPackage.POOL: {
				...
				if (result == null) result = caseMessageVertex(pool);
				if (result == null) result = caseAssociationTarget(pool);
			...
			case BpmnPackage.SEQUENCE_EDGE: {
				...
				if (result == null) result = caseAssociationTarget(sequenceEdge);
			...
			case BpmnPackage.SUB_PROCESS: {
				...
				if (result == null) result = caseMessageVertex(subProcess);
				if (result == null) result = caseArtifactsContainer(subProcess);
				if (result == null) result = caseAssociationTarget(subProcess);
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Message Vertex</em>'.
	 * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Message Vertex</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
    public T caseMessageVertex(MessageVertex object) {
		return null;
	}
