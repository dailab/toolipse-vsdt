...
/**
 * This is the item provider adapter for a {@link de.dailab.vsdt.OutputSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputSetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputSet_outputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputSet_outputs_feature", "_UI_OutputSet_type"),
				 VsdtPackage.Literals.OUTPUT_SET__OUTPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_OutputSet_type");
	}
