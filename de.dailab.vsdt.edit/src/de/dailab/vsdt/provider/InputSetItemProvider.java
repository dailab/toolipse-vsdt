...
/**
 * This is the item provider adapter for a {@link de.dailab.vsdt.InputSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputSetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputSet_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputSet_inputs_feature", "_UI_InputSet_type"),
				 VsdtPackage.Literals.INPUT_SET__INPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_InputSet_type");
	}
