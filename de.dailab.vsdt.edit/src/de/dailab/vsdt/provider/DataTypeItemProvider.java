...
/**
 * This is the item provider adapter for a {@link de.dailab.vsdt.DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VsdtPackage.Literals.DATA_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_package_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_package_feature", "_UI_DataType_type"),
				 VsdtPackage.Literals.DATA_TYPE__PACKAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_language_feature", "_UI_DataType_type"),
				 VsdtPackage.Literals.DATA_TYPE__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_url_feature", "_UI_DataType_type"),
				 VsdtPackage.Literals.DATA_TYPE__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInheritsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_inherits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_inherits_feature", "_UI_DataType_type"),
				 VsdtPackage.Literals.DATA_TYPE__INHERITS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMembersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_members_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_members_feature", "_UI_DataType_type"),
				 VsdtPackage.Literals.DATA_TYPE__MEMBERS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
