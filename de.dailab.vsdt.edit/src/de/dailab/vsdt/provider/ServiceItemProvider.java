...
/**
 * This is the item provider adapter for a {@link de.dailab.vsdt.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VsdtPackage.Literals.SERVICE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addParticipantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_participant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_participant_feature", "_UI_Service_type"),
				 VsdtPackage.Literals.SERVICE__PARTICIPANT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_interface_feature", "_UI_Service_type"),
				 VsdtPackage.Literals.SERVICE__INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_operation_feature", "_UI_Service_type"),
				 VsdtPackage.Literals.SERVICE__OPERATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VsdtPackage.Literals.SERVICE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_location_feature", "_UI_Service_type"),
				 VsdtPackage.Literals.SERVICE__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VsdtPackage.Literals.SERVICE__INPUT,
