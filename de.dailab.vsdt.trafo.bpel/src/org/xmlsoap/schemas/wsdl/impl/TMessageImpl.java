...
public class TMessageImpl extends TExtensibleDocumentedImpl implements TMessage {
	...
	protected EClass eStaticClass() {
		return WsdlPackage.Literals.TMESSAGE;
	}
	 ...
	 * @generated
	 */
	public EList<TPart> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<TPart>(TPart.class, this, WsdlPackage.TMESSAGE__PART);
		}
		return part;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case WsdlPackage.TMESSAGE__PART:
				getPart().clear();
				getPart().addAll((Collection<? extends TPart>)newValue);
				return;
			case WsdlPackage.TMESSAGE__NAME:
