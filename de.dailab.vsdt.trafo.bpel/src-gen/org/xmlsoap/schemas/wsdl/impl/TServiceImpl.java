...
public class TServiceImpl extends TExtensibleDocumentedImpl implements TService {
	...
	protected EClass eStaticClass() {
		return WsdlPackage.Literals.TSERVICE;
	}
	 ...
	 * @generated
	 */
	public EList<TPort> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<TPort>(TPort.class, this, WsdlPackage.TSERVICE__PORT);
		}
		return port;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case WsdlPackage.TSERVICE__PORT:
				getPort().clear();
				getPort().addAll((Collection<? extends TPort>)newValue);
				return;
			case WsdlPackage.TSERVICE__NAME:
