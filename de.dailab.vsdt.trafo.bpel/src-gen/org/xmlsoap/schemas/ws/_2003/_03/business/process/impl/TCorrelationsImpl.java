...
public class TCorrelationsImpl extends TExtensibleElementsImpl implements TCorrelations {
	 ...
	 * @ordered
	 */
	protected EList<TCorrelation> correlation;
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.TCORRELATIONS;
	}
	 ...
	 * @generated
	 */
	public EList<TCorrelation> getCorrelation() {
		if (correlation == null) {
			correlation = new EObjectContainmentEList<TCorrelation>(TCorrelation.class, this, ProcessPackage.TCORRELATIONS__CORRELATION);
		}
		return correlation;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ProcessPackage.TCORRELATIONS__CORRELATION:
				...
				getCorrelation().addAll((Collection<? extends TCorrelation>)newValue);
				return;
		}
