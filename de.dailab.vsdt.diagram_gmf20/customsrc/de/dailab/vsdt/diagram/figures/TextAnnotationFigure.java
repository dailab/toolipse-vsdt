...
public class TextAnnotationFigure extends RectangleFigure {
	...
	private void createContents() {
		...
		setFigureTextAnnotationTextFigure(label);
	...
	private WrapLabel fTextAnnotationTextFigure;

	public WrapLabel getFigureTextAnnotationTextFigure() {
		return fTextAnnotationTextFigure;
	}

	private void setFigureTextAnnotationTextFigure(WrapLabel fig) {
		fTextAnnotationTextFigure = fig;
	}
