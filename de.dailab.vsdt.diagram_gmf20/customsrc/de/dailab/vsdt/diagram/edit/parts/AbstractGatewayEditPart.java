 ...
 */
public abstract class AbstractGatewayEditPart extends AbstractGmfBorderedShapeEditPart implements IVsdtEditPart {
	...
	protected IFigure initNodeShape() {
		...
		GatewayFigure figure= new GatewayFigure(useColor, getCastedModel()
