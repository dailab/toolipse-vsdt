 ...
 */
public abstract class AbstractStartEditPart extends AbstractGmfBorderedShapeEditPart implements IVsdtEditPart {
	...
	protected IFigure initNodeShape() {
		...
		EventFigure figure= new EventFigure(useColor, EventFigure.START, getCastedModel()
				.getTrigger().getValue());
		return figure;
	}
