 ...
 */
public abstract class AbstractEndEditPart extends AbstractGmfBorderedShapeEditPart implements IVsdtEditPart {
	
	/**
	 * the standard constructor
	 */
	public AbstractEndEditPart(View view) {
		super(view);
	}
	 ...
	 */
	public End getCastedModel() {
		return (End) ((View) getModel()).getElement();
	}
	...
	protected IFigure initNodeShape() {
		...
		EventFigure figure= new EventFigure(useColor, EventFigure.END, getCastedModel().getTrigger().getValue());
		return figure;
	}
