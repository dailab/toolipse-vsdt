 ...
 * @generated
 */
public class EndViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = VsdtVisualIDRegistry.getType(EndEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				VsdtVisualIDRegistry.getType(EndNameEditPart.VISUAL_ID),
