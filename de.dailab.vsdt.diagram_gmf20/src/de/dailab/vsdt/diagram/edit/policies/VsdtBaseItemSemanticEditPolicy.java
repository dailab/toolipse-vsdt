...
public class VsdtBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static final VsdtAbstractExpression SequenceFlow_3001_TargetExpression;
		...
		static {
			...
			env.put(OPPOSITE_END_VAR, VsdtPackage.eINSTANCE.getFlowObject());
		 ...
		 * @generated
		 */
		private static final VsdtAbstractExpression MessageFlow_3002_TargetExpression;
		...
		static {
			Map env = new HashMap(3);
			env.put(OPPOSITE_END_VAR, VsdtPackage.eINSTANCE.getNode());
		...
		public static boolean canExistSequenceFlow_3001(
				BusinessProcessDiagram container, FlowObject source,
				FlowObject target) {
			if (!evaluate(SequenceFlow_3001_TargetExpression, target, source,
					true)) {
				return false;
			}
			return true;
		...
		public static boolean canExistMessageFlow_3002(
				BusinessProcessDiagram container, Node source, Node target) {
			if (!evaluate(MessageFlow_3002_TargetExpression, target, source,
					true)) {
				return false;
			}
			return true;
		 ...
		 * @generated
		 */
		private static boolean evaluate(VsdtAbstractExpression constraint,
