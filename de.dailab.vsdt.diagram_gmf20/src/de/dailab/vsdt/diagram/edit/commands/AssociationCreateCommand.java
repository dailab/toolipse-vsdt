...
public class AssociationCreateCommand extends CreateElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && !(source instanceof GraphicalObject)) {
			return false;
		}
		if (target != null && !(target instanceof GraphicalObject)) {
			return false;
		}
		if (getSource() == null) {
	...
	protected EObject doDefaultElementCreation() {
		// de.dailab.vsdt.Association newElement = (de.dailab.vsdt.Association) super.doDefaultElementCreation();
		Association newElement = VsdtFactory.eINSTANCE.createAssociation();
