...
public class SequenceFlowCreateCommand extends CreateElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && !(source instanceof FlowObject)) {
			return false;
		}
		if (target != null && !(target instanceof FlowObject)) {
			return false;
		}
		if (getSource() == null) {
	...
	protected EObject doDefaultElementCreation() {
		// de.dailab.vsdt.SequenceFlow newElement = (de.dailab.vsdt.SequenceFlow) super.doDefaultElementCreation();
