 ...
 * @generated
 */
public class StartNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				VsdtVisualIDRegistry
						.getType(de.dailab.vsdt.diagram.edit.parts.StartNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
					VsdtElementTypes.Start_2002, getParserElement(), parserHint);
