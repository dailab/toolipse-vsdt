 ...
 * @generated
 */
public class AgentNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				VsdtVisualIDRegistry
						.getType(de.dailab.vsdt.diagram.edit.parts.AgentNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
					VsdtElementTypes.Agent_1005, getParserElement(), parserHint);
