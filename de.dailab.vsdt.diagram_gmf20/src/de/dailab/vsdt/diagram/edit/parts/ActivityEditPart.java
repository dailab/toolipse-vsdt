...
import de.dailab.vsdt.diagram.edit.policies.ActivityCanonicalEditPolicy;
import de.dailab.vsdt.diagram.edit.policies.ActivityItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class ActivityEditPart extends AbstractActivityEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = initNodeShape();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivitySubprocessCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getActivityCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ActivitySubprocessCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Intermediate2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.SOUTH);
			locator.setBorderItemOffset(new Dimension(20, 20));
			getBorderedFigure().getBorderItemContainer().add(
					((Intermediate2EditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivitySubprocessCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getActivityCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ActivitySubprocessCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Intermediate2EditPart) {
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof ActivitySubprocessCompartmentEditPart) {
			return getPrimaryShape().getActivityCompartmentFigure();
		}
		if (editPart instanceof Intermediate2EditPart) {
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if (notification.getEventType() == Notification.REMOVE
				&& notification.getFeature() == VsdtPackage.eINSTANCE.getActivity_BoundaryEvents()) {
