...
public abstract class VsdtAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(VsdtDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected VsdtAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	public static final VsdtAbstractExpression createNullExpression(
			EClassifier context) {
		return new VsdtAbstractExpression(context) {
