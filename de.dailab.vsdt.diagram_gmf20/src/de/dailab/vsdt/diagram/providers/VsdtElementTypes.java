...
public class VsdtElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType Agent_1005 = getElementType("de.dailab.vsdt.diagram.Agent_1005"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Service_1006 = getElementType("de.dailab.vsdt.diagram.Service_1006"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Agent_1005, VsdtPackage.eINSTANCE.getAgent());

			elements.put(Service_1006, VsdtPackage.eINSTANCE.getService());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Agent_1005);
			KNOWN_ELEMENT_TYPES.add(Service_1006);
