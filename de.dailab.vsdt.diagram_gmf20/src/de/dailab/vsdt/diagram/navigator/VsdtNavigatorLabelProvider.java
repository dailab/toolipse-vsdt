...
public class VsdtNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case AgentEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://de.dailab.vsdt?Agent", VsdtElementTypes.Agent_1005); //$NON-NLS-1$
		case ServiceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://de.dailab.vsdt?Service", VsdtElementTypes.Service_1006); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case AgentEditPart.VISUAL_ID:
			return getAgent_1005Text(view);
		case ServiceEditPart.VISUAL_ID:
			return getService_1006Text(view);
		case LaneEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getAgent_1005Text(View view) {
		IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
				VsdtElementTypes.Agent_1005, (view.getElement() != null ? view
						.getElement() : view), VsdtVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getService_1006Text(View view) {
		IAdaptable hintAdapter = new VsdtParserProvider.HintAdapter(
				VsdtElementTypes.Service_1006,
				(view.getElement() != null ? view.getElement() : view),
				VsdtVisualIDRegistry.getType(ServiceNameEditPart.VISUAL_ID));
		IParser parser = ParserService.getInstance().getParser(hintAdapter);
